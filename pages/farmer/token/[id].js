  ...
  return (
    <div className="min-h-screen bg-slate-100/70 dark:bg-neutral-950 px-4 py-8 print:bg-white print:p-0 text-slate-900 dark:text-white transition-colors">
      <div className="max-w-lg mx-auto space-y-4">
        ...
        <div className="bg-white dark:bg-neutral-900 rounded-3xl shadow-xl border-2 border-emerald-800 dark:border-emerald-700 overflow-hidden print:shadow-none print:border-2 print:border-black print:rounded-none">
